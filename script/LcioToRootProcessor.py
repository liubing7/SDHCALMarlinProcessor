...
def launch(a , files) :
	...
	xml = '''<marlin>
 <execute>
  <processor name="LcioToRootProcessor"/>
 </execute>
 ...
 <processor name="LcioToRootProcessor" type="LcioToRootProcessor">

  <parameter name="inputHitCollection" type="stringVec" lcioInType="CalorimeterHit">''' + a.collectionName + '''</parameter>
  <parameter name="inputRelCollection" type="stringVec" lcioInType="LCRelation"> RelationParticleToHit </parameter>
  <parameter name="inputMCParticleCollection" type="string" lcioInType="MCParticle"> primaryParticles </parameter>
