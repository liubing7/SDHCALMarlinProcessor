...
#FILEPATH="/home/garillot/files/local/CalorimeterHit/thrScan"
#FILELIST=`ls ${FILEPATH} | grep -F 4.58_1.12.slcio`
#COLLECTION="HCALEndcapAnalog"

OUTPUT="${polyaQ}_${polyaD}_${d}graphs.root"
...
<marlin>
 <execute>
  <processor name="AnalogEfficiencyProcessor"/>
 </execute>
 ...
 <processor name="AnalogEfficiencyProcessor" type="AnalogEfficiencyProcessor">
...
mv ${OUTPUT} /home/garillot/files/PolyaScan/Graphs
